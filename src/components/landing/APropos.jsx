export default function APropos() {
  return (
    <section id="apropos" className="py-32 px-6 bg-surface-container-lowest border-t border-surface-container-high">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-16 reveal opacity-0 translate-y-12 transition-all duration-1000 ease-out">
        ...
        <div>
          ...
          <h2 className="font-display-lg text-3xl md:text-4xl tracking-tight mb-4 text-on-surface">Julien D.</h2>
          ...
          <p className="font-body-lg text-on-surface-variant text-lg leading-relaxed max-w-2xl">
            Avec plus de 10 ans d&apos;expérience en conception d&apos;interfaces, j&apos;ai passé la dernière année à
            intégrer l&apos;intelligence artificielle au cœur de mes flux de travail. Mon but avec{' '}
            <b className="text-on-surface">Vibe Hub</b> : vous aider à décupler votre productivité de designer sans
            compromettre votre créativité.
          </p>
        </div>
      </div>
    </section>
